...
export default function ApartmentDetailPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <main className="bg-white min-h-screen pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        {/* Header */}
        <div className="mb-12">
          <Link href="/apartments/ongoing" className="text-[#FBB150] font-semibold hover:underline mb-4 inline-block">
            ← Back to Ongoing Apartments
          </Link>
          <h1 className="text-4xl md:text-5xl font-bold text-[#142B6D]">{apt.name}</h1>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="bg-white rounded-3xl p-8 border border-gray-100 shadow-xl shadow-gray-200/40 relative overflow-hidden">
              ...
              <div 
                ...
                dangerouslySetInnerHTML={{ __html: formatAboutText(apt.aboutText) }}
              />
            </section>
          ...
          <div className="lg:col-span-1 space-y-6 sticky top-32 self-start">
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 text-center">
              ...
              <a 
                href={`https://wa.me/919363726148?text=Hi, I am interested in ${encodeURIComponent(apt.name)}. Could you share more details?`}
                target="_blank"
