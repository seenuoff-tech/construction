  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-2xl font-bold text-gray-900">Manage Villas</h1>
        <button 
          ...
          <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-xl">
            <div className="sticky top-0 bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between z-10">
              <h2 className="text-xl font-bold text-gray-900">
                {editingItem ? 'Edit Villa' : 'Add New Villa'}
              </h2>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input name="type" defaultValue={editingItem?.type} placeholder="e.g. 3, 4" className="w-full px-4 py-2 border rounded-lg focus:ring-[#142B6D] focus:border-[#142B6D] text-gray-900 bg-white" />
                </div>
                <div>
