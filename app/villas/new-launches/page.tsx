...
import { MapPin, Maximize, FileCheck, Home, Calendar, Rocket } from 'lucide-react';

export default function NewLaunchVillasPage() {
  const allVillas = getVillas();
  const villas = allVillas.filter(v => v.category === 'new-launch');
    ...
    <main className="bg-white min-h-screen pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-[#142B6D] mb-4">New Launch Villas</h1>
          <div className="w-24 h-1.5 bg-[#FBB150] mx-auto rounded-full" />
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {villas.map((villa) => (
            <div key={villa.slug} className="bg-white rounded-3xl overflow-hidden shadow-lg border border-gray-100 flex flex-col hover:-translate-y-2 transition-transform duration-300 relative">
              ...
              <div className="p-6 flex flex-col flex-1">
                <div className="flex flex-col gap-4 mb-8 flex-1">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-bold text-purple-700">{villa.launchDate || villa.handOverDate}</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center gap-4 mt-auto">
                  ...
                  <a 
                    href={`https://wa.me/919363726148?text=Hi, I am interested in the NEW LAUNCH ${encodeURIComponent(villa.name)}. Could you share more details?`}
                    target="_blank"
