import { getVillaBySlug, getVillas } from '@/lib/villas';
  ...
  return (
    <main className="bg-white min-h-screen pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        {/* Header */}
        <div className="mb-12">
          <Link href="/villas/ongoing" className="text-[#FBB150] font-semibold hover:underline mb-4 inline-block">
            ← Back to Ongoing Villas
          </Link>
          <h1 className="text-4xl md:text-5xl font-bold text-[#142B6D]">{villa.name}</h1>
        </div>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="bg-white rounded-3xl p-8 border border-gray-100 shadow-xl shadow-gray-200/40 relative overflow-hidden">
              ...
              <div 
                ...
                dangerouslySetInnerHTML={{ __html: formatAboutText(villa.aboutText) }}
              />
            </section>
